...
export default function Footer({setTab}) {
  ...
  return(
      <Box safeAreaTop width="100%" justifyContent={"center"} alignSelf={"center"} >
        ...
        <HStack alignItems="center" safeAreaBottom shadow={6} >
          ...
          <Pressable cursor="pointer" bg={"muted.300"} padding={"5"} opacity={selected === 1 ? 1 : 0.5} py="3" onPress={() => setStates(1, setSelected, setTab)}>
            <Center>
